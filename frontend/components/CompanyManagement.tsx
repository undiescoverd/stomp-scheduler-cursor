  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="w-full max-w-6xl h-[90vh] bg-white rounded-lg shadow-xl flex flex-col">
        {/* Fixed Header */}
        <div className="flex-shrink-0 border-b bg-white rounded-t-lg">
          <CardHeader>
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
          <CardContent className="flex-1 p-6 overflow-hidden">
            <Tabs defaultValue="current" className="h-full flex flex-col">
              ...
              <TabsContent value="current" className="flex-1 mt-4 overflow-y-auto">
              ...
              <TabsContent value="archive" className="flex-1 mt-4 overflow-y-auto">
                <div className="space-y-4 pr-2">
                  {/* Archive Filter Tabs */}
