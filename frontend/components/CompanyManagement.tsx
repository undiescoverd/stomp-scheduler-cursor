...
import { Users, Archive, Plus, Edit3, ArrowUp, X, Search, UserPlus, GripVertical, Trash2 } from 'lucide-react';
      ...
      <Tabs defaultValue="current" className="w-full">
        ...
        <TabsContent value="current" className="mt-6">
          <div className="space-y-6">
            ...
            {/* Current Company List - 2 Column Grid */}
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex flex-col items-end space-y-2 ml-4">
                          ...
                          <Button
                            ...
                            className="text-red-600 hover:text-red-700 w-32"
                          >
        ...
        <TabsContent value="archive" className="mt-6">
          <div className="space-y-6">
            ...
            <Tabs value={archiveFilter} onValueChange={(value) => setArchiveFilter(value as any)} className="w-full">
              ...
              <TabsContent value={archiveFilter} className="mt-6">
                {/* Archive List - 2 Column Grid */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1 space-y-3">
                              ...
                              {member.archiveReason && (
                                <p className="text-xs text-gray-500">{member.archiveReason}</p>
                              )}
                            ...
                            <div className="flex flex-col items-end space-y-2 ml-4">
                              <Button
                                ...
                                className="text-green-600 hover:text-green-700 w-24"
                              >
